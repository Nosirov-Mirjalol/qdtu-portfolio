import { UserRound, CheckCircle2, Flame } from "lucide-react";
...
export function ProfileSidebar({ profile, newImage, complation }: ProfileSidebarProps) {
  ...
  return (
    <div className="w-full lg:w-72 lg:shrink-0 animate-in fade-in duration-500">
      <div className="group rounded-[24px] border border-border/40 bg-card overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <div className="relative aspect-square w-full bg-muted overflow-hidden">
          ...
          <div className="absolute bottom-4 left-4 right-4 text-white">
            ...
            <p className="text-[11px] text-white/80 font-medium mt-0.5">{profile.lavozimName}</p>
          </div>
        </div>
        ...
        <div className="p-5 space-y-4">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className={`px-2.5 py-1 rounded-full text-[10px] font-bold whitespace-nowrap shadow-sm border ${
              percentage > 80 
